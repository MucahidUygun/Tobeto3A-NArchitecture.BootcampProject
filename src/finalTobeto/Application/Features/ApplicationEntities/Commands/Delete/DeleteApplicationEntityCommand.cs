...
public class DeleteApplicationEntityCommand : IRequest<DeletedApplicationEntityResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class DeleteApplicationEntityCommandHandler : IRequestHandler<DeleteApplicationEntityCommand, DeletedApplicationEntityResponse>
    {
        ...
        public DeleteApplicationEntityCommandHandler(IMapper mapper, IApplicationEntityRepository applicationEntityRepository,
        ...
        public async Task<DeletedApplicationEntityResponse> Handle(DeleteApplicationEntityCommand request, CancellationToken cancellationToken)
        {
