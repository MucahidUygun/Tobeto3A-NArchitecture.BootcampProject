...
public class UpdateApplicationEntityCommand : IRequest<UpdatedApplicationEntityResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class UpdateApplicationEntityCommandHandler : IRequestHandler<UpdateApplicationEntityCommand, UpdatedApplicationEntityResponse>
    {
        ...
        public UpdateApplicationEntityCommandHandler(IMapper mapper, IApplicationEntityRepository applicationEntityRepository,
        ...
        public async Task<UpdatedApplicationEntityResponse> Handle(UpdateApplicationEntityCommand request, CancellationToken cancellationToken)
        {
