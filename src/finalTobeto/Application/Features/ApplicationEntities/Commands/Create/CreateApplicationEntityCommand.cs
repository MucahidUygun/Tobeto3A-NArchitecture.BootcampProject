...
public class CreateApplicationEntityCommand : IRequest<CreatedApplicationEntityResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class CreateApplicationEntityCommandHandler : IRequestHandler<CreateApplicationEntityCommand, CreatedApplicationEntityResponse>
    {
        ...
        public CreateApplicationEntityCommandHandler(IMapper mapper, IApplicationEntityRepository applicationEntityRepository,
        ...
        public async Task<CreatedApplicationEntityResponse> Handle(CreateApplicationEntityCommand request, CancellationToken cancellationToken)
        {
