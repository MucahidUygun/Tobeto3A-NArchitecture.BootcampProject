...
public class GetByIdApplicationEntityQuery : IRequest<GetByIdApplicationEntityResponse>, ISecuredRequest
{
    ...
    public class GetByIdApplicationEntityQueryHandler : IRequestHandler<GetByIdApplicationEntityQuery, GetByIdApplicationEntityResponse>
    {
        ...
        public GetByIdApplicationEntityQueryHandler(IMapper mapper, IApplicationEntityRepository applicationEntityRepository, ApplicationEntityBusinessRules applicationEntityBusinessRules)
        {
            _mapper = mapper;
        ...
        public async Task<GetByIdApplicationEntityResponse> Handle(GetByIdApplicationEntityQuery request, CancellationToken cancellationToken)
        {
